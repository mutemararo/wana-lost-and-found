...
import com.example.wana_lost_and_found.databinding.FragmentLostReportsBinding
...
class LostReportsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listAdapter = ReportsListAdapter(requireContext(), lostItemsList){reportId, reportedBy, reportType ->
