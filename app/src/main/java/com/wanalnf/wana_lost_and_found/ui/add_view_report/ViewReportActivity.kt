...
import com.wanalnf.wana_lost_and_found.databinding.ActivityViewReportBinding
                ...
                if (receivingIntent.getStringExtra(REPORT_STATUS_EXTRA_KEY) == ReportStatus.CLAIMED.status){
                    ...
                    buttonAction.setOnClickListener {
                        val dialogBuilder = MaterialAlertDialogBuilder(this@ViewReportActivity)
                            ...
                            .setPositiveButton("Yes"){_, _ ->
                                showProgress()
                                //update the found item`s reportStatus variable to claimed(previously reported) (variable is used for pending collections)
                                databaseReference
                                    .child("reports")
